        ...
        ****************/
        function selectChange() {
            ...
            selectPosition.addEventListener('change', () => {
                ...
                if (selectPosition.value === 'Head of delegation') {
                    toggleDisplay('remove');
                ...
                if (selectPosition.value === 'Government official') {
                    toggleDisplay('remove');
                    innerElementsDisabledToggle(formInnerElement, true);
                    isDatesDisabled(true);
                }

                if (selectPosition.value === 'Participant') {
                    toggleDisplay('remove');
                    innerElementsDisabledToggle(formInnerElement, true);
                    isDatesDisabled(true);
                }
                ...
                if (selectPosition.value === 'Press') {
                    toggleDisplay('remove');
                    formInners[3].classList.add('active');
                    innerElementsDisabledToggle(formInnerElement, true);
                    isDatesDisabled(true);
                }

                if (selectPosition.value === 'Technical staff') {
                    toggleDisplay('remove');
                    innerElementsDisabledToggle(formInnerElement, true);
                    isDatesDisabled(true);
                }
            ...
            const selectPostion2 = document.getElementById('position_select-1');
            const currentPosition2 = document.getElementById('current-position-p2');
            currentPosition2.disabled = true;
            currentPosition2.parentNode.style.display = 'none';

            selectPostion2.addEventListener('change', () => {
                if (selectPostion2.value === 'Other') {
                    currentPosition2.disabled = false;
                    currentPosition2.parentNode.style.display = 'block';
                } else {
                    currentPosition2.disabled = true;
                    currentPosition2.parentNode.style.display = 'none';
                }
            ...
            const selectPostion3 = document.getElementById('position_select-2');
            const currentPosition3 = document.getElementById('current-position-p3');
            selectPostion3.disabled = true;
            currentPosition3.parentNode.style.display = 'none';

            selectPostion3.addEventListener('change', () => {
                if (selectPostion3.value === 'Other') {
                    currentPosition3.disabled = false;
                    currentPosition3.parentNode.style.display = 'block';
                } else {
                    currentPosition3.disabled = true;
                    currentPosition3.parentNode.style.display = 'none';
                }
            })
       ...
       ****************/
        ...
        ****************/
        ...
        $('#registration-form').submit(function (event) {
            ...
            $.ajax({
                url: 'https://lldcadmin.agro.uz/api/data',
                type: 'POST',
                dataType: 'json',
                data: formData,
                processData: false,
